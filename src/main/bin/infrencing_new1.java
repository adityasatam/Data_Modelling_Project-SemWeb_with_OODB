...
//======================================================================================================
        ...
        HashMap<String,String> transitive=new HashMap<String, String>();
        ...
        while (nodeIterator.hasNext()) {
            ...
            if (extendedIterator.hasNext()) {
                ...
                transitive.put("city","isLocatedIn");
            }
        }
        String sub11="a" , pred11=null, obj11=null, sub22=null, pred22=null, obj22="b", newpred="issituatedIn";
...
//                }
            ...
            while (flag == 1) {
                ...
                if (inverse.containsKey(pred)) {
                    ...
                    int s = pto.get(list1).size();
                    pto.get(list1).add(sub);
                    if(s==pto.get(list1).size())
                    { flag=0; break;}
            ...
            if(transitive.containsKey(pred)){
                sub11=sub;
                pred11=pred;
                obj11=obj;
            }
            if(transitive.containsValue(pred)){
                sub22=sub;
                pred22=pred;
                obj22=obj;
            }
            if(sub11.equals(obj22)){
                stp.put(sub22,new HashSet<String>());
                stp.get(sub22).add(pred22);
                List<String> list2 = new ArrayList<String>();
                list2.add(pred22);
                pto.put(list2, new HashSet<String>());
                pto.get(list2).add(obj11);
            }
        }
        ...
        while (a == 1 || a == 2) {
            while (a == 1) {
                ...
                Set<String> list_o1 = new HashSet<String>();
                ...
                temp1.add(name_p);
                temp.add(name_p);
                System.out.println("name_s is "+name_s);
                System.out.println("name_p is "+name_p);
                System.out.println("temp is "+temp);
                list_o = pto.get(temp);
                list_o1 = pto.get(temp1);

                System.out.println(list_o);

                System.out.println("FINAL RESULT\n\n");

                if((list_o==list_o1) || (list_o==null)){
                    System.out.println("With subject '" + name_s + "' predicate '" + name_p + "' object is => " + list_o1 + "\n\n");
                    System.out.println(name_s + " " + name_p + " " + list_o1 + "\n\n");
                }
                else if((list_o==list_o1) || (list_o1==null)){
                    System.out.println("With subject '" + name_s + "' predicate '" + name_p + "' object is => " + list_o + "\n\n");
                    System.out.println(name_s + " " + name_p + " " + list_o1 + "\n\n");
                }
                else{
                    System.out.println("With subject '" + name_s + "' predicate '" + name_p + "' object is => " + list_o + " " + list_o1+"\n\n");
                    System.out.println(name_s + " " + name_p + " " + list_o + " " + list_o1 + "\n\n");
                }
